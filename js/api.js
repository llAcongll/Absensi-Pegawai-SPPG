...
const API_BASE_URL = 'https://script.google.com/macros/s/AKfycbyKG-kByI0Ku5U9MxXETwy4Q1crY0AGJMC59fpRQzVM8igBKwYXkw-hDm7ZI-JA4pB3/exec'; // Kosongkan untuk mode localStorage, isi dengan URL Web App GAS
...
const api = {
    ...
    async updateShift(id, data) {
        ...
        if (!API_BASE_URL) {
            return { success: true, data: all[idx] || data };
        }
