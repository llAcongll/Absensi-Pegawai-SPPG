...
function initializeData() {
    ...
    if (!storage.get('admin_employees')) {
        storage.set('admin_employees', [
            { id: 1, name: 'Ahmad Rizky', email: 'ahmad@company.com', department: 'Kitchen', position: 'Koki Utama', shift: 'Pagi', status: 'active', joinDate: '2024-01-15', avatar: 'https://ui-avatars.com/api/?name=Ahmad&background=3B82F6&color=fff' },
            { id: 2, name: 'Budi Santoso', email: 'budi@company.com', department: 'Packing/Pemorsian', position: 'Supervisor Packing', shift: 'Pagi', status: 'active', joinDate: '2023-06-01', avatar: 'https://ui-avatars.com/api/?name=Budi&background=10B981&color=fff' },
